ActiveAdmin.setup do |config|
  ...
  #
  if HeimdallEnvironment.environment == 'production'
    config.site_title = "Heimdall"
  else
    config.site_title = "Heimdall&nbsp;&nbsp;|&nbsp;&nbsp;<b>#{HeimdallEnvironment.environment.titleize}</b>".html_safe
  end
  ...
  config.maximum_association_filter_arity = 100
