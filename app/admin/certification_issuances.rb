ActiveAdmin.register CertificationIssuance do
  ...
  filter :issued_at
  filter :certifier_id, as: :search_select_filter, url: ->(_) { admin_users_path }, display_name: 'name_and_email'
  ...
  form do |f|
    f.inputs do
      ...
      f.input :user_id, as: :search_select, display_name: 'name_and_email', hint: "The user who is receiving the certification, if they have a user in the system. (If they don't and if you can't create one right now, leave this blank and enter their name into \"Tentative recipient name\".)"
      ...
      f.input :certifier_id, as: :search_select, url: admin_users_path, display_name: 'name_and_email', hint: 'The user who performed the certification, if known'
