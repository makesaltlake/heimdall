ActiveAdmin.register User do
  ...
  filter :badge_number_equals, label: 'Old-Style Badge Number'
  ...
  show do
    attributes_table do
      ...
      row('Old-style badge number') { |user| user.badge_number && reveal_link("Badge number: #{user.badge_number}") }
  ...
  form do |f|
    f.inputs do
      ...
      f.input(:badge_number, label: 'Old-style badge number', hint: "Work in progress, ignore this field for now")
